...
class TransactionServiceApi:
    ...
    def build_java_script_url(self, space_id, id, **kwargs):
        ...
        >>> thread = api.build_java_script_url(space_id, id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.build_java_script_url_with_http_info(space_id, id, **kwargs)
        else:
            (data) = self.build_java_script_url_with_http_info(space_id, id, **kwargs)
            return data

    def build_java_script_url_with_http_info(self, space_id, id, **kwargs):
        """Build JavaScript URL

        This operation creates the URL which can be used to embed the JavaScript for handling the iFrame checkout flow.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_java_script_url_with_http_info(space_id, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method build_java_script_url" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('space_id' not in params or
            ...
            raise ValueError("Missing the required parameter `space_id` when calling `build_java_script_url`")
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `build_java_script_url`")
        ...
        return self.api_client.call_api(
            '/transaction/buildJavaScriptUrl', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def build_mobile_sdk_url_with_credentials(self, credentials, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_mobile_sdk_url_with_credentials(credentials, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.build_mobile_sdk_url_with_credentials_with_http_info(credentials, **kwargs)
        else:
            (data) = self.build_mobile_sdk_url_with_credentials_with_http_info(credentials, **kwargs)
            return data

    def build_mobile_sdk_url_with_credentials_with_http_info(self, credentials, **kwargs):
        """Build Mobile SDK URL with Credentials

        This operation builds the URL which is used to load the payment form within a WebView on a mobile device. This operation is typically called through the mobile SDK.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_mobile_sdk_url_with_credentials_with_http_info(credentials, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method build_mobile_sdk_url_with_credentials" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('credentials' not in params or
            ...
            raise ValueError("Missing the required parameter `credentials` when calling `build_mobile_sdk_url_with_credentials`")
        ...
        return self.api_client.call_api(
            '/transaction/buildMobileSdkUrlWithCredentials', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def build_payment_page_url(self, space_id, id, **kwargs):
        """Build Payment Page URL

        This operation creates the URL to which the user should be redirected to when the payment page should be used.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_payment_page_url(space_id, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.build_payment_page_url_with_http_info(space_id, id, **kwargs)
        else:
            (data) = self.build_payment_page_url_with_http_info(space_id, id, **kwargs)
            return data

    def build_payment_page_url_with_http_info(self, space_id, id, **kwargs):
        """Build Payment Page URL

        This operation creates the URL to which the user should be redirected to when the payment page should be used.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_payment_page_url_with_http_info(space_id, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method build_payment_page_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'space_id' is set
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `build_payment_page_url`")
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `build_payment_page_url`")
        ...
        return self.api_client.call_api(
            '/transaction/buildPaymentPageUrl', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
