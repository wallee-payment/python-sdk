...
class UnencryptedCardData:
    ...
    def card_holder_name(self):
        ...
        :return: The card_holder_name of this UnencryptedCardData.
        :rtype: str
        """
    ...
    def card_holder_name(self, card_holder_name):
        """Sets the card_holder_name of this UnencryptedCardData.
    ...
    def card_verification_code(self):
        ...
        :return: The card_verification_code of this UnencryptedCardData.
        :rtype: str
        """
    ...
    def card_verification_code(self, card_verification_code):
        """Sets the card_verification_code of this UnencryptedCardData.
    ...
    def expiry_date(self):
        ...
        :return: The expiry_date of this UnencryptedCardData.
        :rtype: str
        """
    ...
    def expiry_date(self, expiry_date):
        """Sets the expiry_date of this UnencryptedCardData.

            The card expiry date indicates when the card expires. The format is the format yyyy-mm where yyyy is the year (e.g. 2019) and the mm is the month (e.g. 09).

        :param expiry_date: The expiry_date of this UnencryptedCardData.
        :type: str
        """
    ...
    def primary_account_number(self):
        ...
        :return: The primary_account_number of this UnencryptedCardData.
        :rtype: str
        """
    ...
    def primary_account_number(self, primary_account_number):
        """Sets the primary_account_number of this UnencryptedCardData.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UnencryptedCardData, dict):
    ...
    def __eq__(self, other):
        if not isinstance(other, UnencryptedCardData):
            return False
