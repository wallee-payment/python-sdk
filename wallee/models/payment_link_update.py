...
class PaymentLinkUpdate:
    ...
    def billing_address_required(self):
        ...
        :return: The billing_address_required of this PaymentLinkUpdate.
        :rtype: bool
        """
    ...
    def billing_address_required(self, billing_address_required):
        """Sets the billing_address_required of this PaymentLinkUpdate.

            By making the billing address required the transaction can only be created when a billing address is provided within the request.

        :param billing_address_required: The billing_address_required of this PaymentLinkUpdate.
        :type: bool
        """
    ...
    def shipping_address_required(self):
        ...
        :return: The shipping_address_required of this PaymentLinkUpdate.
        :rtype: bool
        """
    ...
    def shipping_address_required(self, shipping_address_required):
        """Sets the shipping_address_required of this PaymentLinkUpdate.

            By making the shipping address required the transaction can only be created when a shipping address is provided within the request.

        :param shipping_address_required: The shipping_address_required of this PaymentLinkUpdate.
        :type: bool
        """
