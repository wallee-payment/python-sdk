...
class AbstractDebtCollectorConfigurationUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["skipReviewEnabled", "name", "enabledSpaceViews", "state", "conditions", "priority"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractDebtCollectorConfigurationUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractDebtCollectorConfigurationUpdate from a dict"""
        if obj is None:
            return None
