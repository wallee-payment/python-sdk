...
class PaymentAppChargeAttemptUpdate(BaseModel):
    ...
    end_user_failure_message: Optional[Annotated[str, Field(strict=True, max_length=2000)]] = Field(default=None, description="A message explaining to the buyer why the payment failed. The message must be localized in the buyer's language, as specified in the payment page invocation URL.", alias="endUserFailureMessage")
    __properties: ClassVar[List[str]] = ["reference", "targetState", "failureReason", "endUserFailureMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentAppChargeAttemptUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentAppChargeAttemptUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "endUserFailureMessage": obj.get("endUserFailureMessage")
        })
        return _obj
